  ...
  return (
    ...
    <main className="home flex flex-col h-full p-4 lg:mx-[5rem]">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-[3rem] place-content-center mt-[40px]">
        ...
        <div className="mt-4 lg:mt-0 flex flex-col bg-[#2B2B2B40] p-2" id="payment">
          ...
          <div className="flex w-full bg-[#1B1B1B] justify-evenly mt-2 border-[1px] border-[#222222]">
            ...
            <div 
              className={`content-center max-w-[164px] max-h-[164px] cursor-pointer ${isUsdtSelected ? 'coinselected' : ''}`}
              onClick={handleUsdtSelected}>
              <svg width="97" height="38" viewBox="0 0 797 738" fill="none" xmlns="http://www.w3.org/2000/svg" className={`coin ${isUsdtSelected ? 'fill-[#039196]' : ''}`}>
