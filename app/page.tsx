...
export default function Home() {
  ...
  return (
    <main className="home flex flex-col h-screen p-4">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-4 place-content-center">
        <div className="bg-[#2B2B2B40] p-2" id="inventorypanel">
          <p className="text-[#FFFFFF4D]">Your Inventory</p>
          <div className="flex flex-col lg:flex-row lg:space-x-4">
            <input type="text" placeholder="Search Item..." className="bg-[#1B1B1B] border-[#222222] border-[1px] text-[#4A4A4A] placeholder-[#4A4A4A]" />
            <select name="items" id="items" className="bg-[#1B1B1B] border-[#222222] border-[1px] text-[#4A4A4A] placeholder-[#4A4A4A]">
            ...
            <div className="bg-[#1B1B1B] border-[#222222] border-[1px] text-[#4A4A4A] placeholder-[#4A4A4A] p-2">
          ...
          <div className="cards-container flex flex-wrap gap-4 mt-[40px]">
            {cards}
          </div>
        ...
        <div className="flex flex-col" id="payment">
          ...
          <div className="flex w-full bg-[#222222] justify-around">
            ...
            <div className="bg-[#222222] content-center p-4 max-w-[164px] max-h-[164px] cursor-pointer border-[#0E959980] border-2">
